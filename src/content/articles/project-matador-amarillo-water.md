---
title: "Project Matador and Amarillo's Water: What Panhandle Landowners Should Know"
excerpt: "Fermi America's Project Matador has locked in up to 900 million gallons of Amarillo water a year and a long-term tax deal in Carson County. Here's what the numbers mean for Panhandle landowners, wells, and the Ogallala."
date: "2026-06-27"
...
But efficiency per server is not the same as total impact. Even an efficient campus this large represents a major, decades-long allocation of a finite supply in a drought-prone region. You can read more about the broader pattern on our [water harm hub](/damage/water).
...
If your well is already struggling, our guide on [what to do if your well runs dry](/articles/what-to-do-if-your-well-runs-dry) walks through the first practical steps.
...
A clear before-and-after picture is far more persuasive than memory alone. For background and local updates, visit our [Amarillo location hub](/locations/amarillo).
...
For the project's own public details, see the [City of Amarillo's Fermi Project page](https://www.amarillo.gov/fermi-project/), the [Panhandle Groundwater Conservation District](https://www.pgcd.us/), and the [Texas House Committee on Natural Resources](https://house.texas.gov/committees/), where the project's water plans were presented in June 2026.
